...
const footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="grid gap-4 lg:grid-cols-4 md:grid-cols-2 bg-dark2 p-4 lg:p-8 pb-4 text-primary"
    >
      <div className="email-list lg:col-span-2 md:col-span-1">
        <div className="input-wrapper flex flex-col lg:flex-row items-center justify-between rounded-sm border border-solid border-primary px-3">
          <input
            type="email"
            className="w-full bg-inherit py-2 outline-none mb-2 lg:mb-0"
